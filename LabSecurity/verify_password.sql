CREATE OR REPLACE FUNCTION SYS.VERIFY_PASSWORD(username varchar2, password varchar2, old_password varchar2)
    RETURN BOOLEAN IS
BEGIN
    ...
    IF NOT regexp_like(password, '^.*[a-z].*$|^.*[A-Z].*$', 'c') THEN
        raise_application_error(-20000,
                                'Password should contain at least 1 upper case, at least 1 lower case, at least 1 digit');
    END IF;
